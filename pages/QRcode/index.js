...
import {AppRegistry, View, StyleSheet, Text, Image, ToastAndroid,TouchableWithoutFeedback} from 'react-native';
import {StackNavigator} from 'react-navigation';

import {Colors, Images} from './resource/';
import avatar from './resource/imgs/avatar.jpg';
            ...
            <View style={styles.view_container}>
                <View style={styles.view_avatar_name_container}>
                    <View style={styles.view_avatar_container}>
                        {console.warn(JSON.stringify(Images,null,true))}
                        {console.warn(avatar)}
                        <Image
